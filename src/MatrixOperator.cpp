...
cv::Mat UVR_SLAM::MatrixOperator::RotationMatrixFromEulerAngle(float a, char c) {
...
cv::Mat UVR_SLAM::MatrixOperator::RotationMatrixFromEulerAngles(float a, float b, float c, std::string str) {
	auto cstr= str.c_str();
