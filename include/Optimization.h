...
namespace UVR_SLAM {
	...
	public:
		...
		static void GroundPlaneInitialize(InitialData* data, std::vector<cv::DMatch> Matches, UVR_SLAM::Frame* pInitFrame1, UVR_SLAM::Frame* pInitFrame2, cv::Mat& P,cv::Mat K, int trial1 = 2, int trial2 = 5);
