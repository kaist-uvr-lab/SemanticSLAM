...
namespace UVR_SLAM {
	...
	class Optimization {
	public:
		static void LocalBundleAdjustment(UVR_SLAM::FrameWindow* pWindow, std::vector<UVR_SLAM::MapPoint*>& vpDeleteMPs, int trial1 = 2, int trial2 = 5, bool bShowStatus = false);
		...
		static int PoseOptimization(UVR_SLAM::FrameWindow* pWindow, UVR_SLAM::Frame* pF, int trial1 = 2, int trial2 = 5);
