...
namespace UVR_SLAM {
	...
	public:
		...
		static int PoseOptimization(UVR_SLAM::Frame* pF, std::vector<UVR_SLAM::MapPoint*> mvpLocalMPs, std::vector<bool>& mvbLocalMPInliers, std::vector<cv::DMatch> mvnLocalMPIDXs, bool bStatus = false, int trial1 = 2, int trial2 = 5);
